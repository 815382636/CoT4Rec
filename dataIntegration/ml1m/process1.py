...
class Dataset(object):
    def __init__(self, dataset, user_dataset, item_dataset, u2i=True):
        self.dataset = rating_data if not dataset else dataset
        self.user_dataset = user_data if not user_dataset else user_dataset
        self.item_dataset = item_data if not item_dataset else item_dataset
        self.use_u2i = u2i
